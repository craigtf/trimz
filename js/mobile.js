window.onload = function(){
	...
	document.getElementById('mobile-navigation').onclick = function(){
		...
		if(a){
			...
			document.getElementById('mobile-navigation').style.backgroundImage='url(images/mobile-menu2.png)';
		} else {
			getNavi.style.display='block';
			document.getElementById('mobile-navigation').style.backgroundImage='url(images/mobile-close2.png)';
		}
	};
